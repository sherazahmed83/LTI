package com.sheraz.tutorial.lti.consumer.tool.controller;
...
import com.sheraz.tutorial.lti.consumer.tool.config.OauthConfig;
import com.sheraz.tutorial.lti.consumer.tool.config.ParamConfig;
...
public class ConsumerController {
	...
	public String getDefaultHomePage(Model model) {
		...
		paramsMap.put("oauth_signature",
				oauthConfig.getOAuthSignature(paramsMap, oauthConsumerKey, secret, url, "POST"));
	...
	@PostMapping("/")
	public String getGradesFromTool(HttpServletRequest request, Model model) {
